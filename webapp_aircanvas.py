...
paint_window_frame_placeholder = st.empty()
...
while cap.isOpened() and not stop_button_pressed:
    ...
    paint_window_image_normalized = paintWindow / 255.0


    
    camera_frame_placeholder.image(image_normalized,channels="RGB",use_column_width = True,width =400)
    paint_window_frame_placeholder.image(paint_window_image_normalized,channels="BGR",use_column_width = True)
